...
<div class="col-md-4">
    ...
    <div>
        <a href=”/edit/${furniture._id}” class="btn btn-info" style"display: ${furniture._ownerId == localStorage ? 'inline' : 'none'}">Edit</a>
        <a href=”#” id="${furniture._id}" class="btn btn-red" style"display: ${furniture._ownerId == localStorage ? 'inline' : 'none'}">Delete</a>
    </div>
</div>
</div>`
